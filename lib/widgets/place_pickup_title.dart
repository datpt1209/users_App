...
class PlacePredictionPickUpDesign extends StatefulWidget
{
  ...
  PlacePredictionPickUpDesign({this.predictedPlaces});

  @override
  State<PlacePredictionPickUpDesign> createState() => _PlacePredictionPickUpDesignState();
}

class _PlacePredictionPickUpDesignState extends State<PlacePredictionPickUpDesign> {
